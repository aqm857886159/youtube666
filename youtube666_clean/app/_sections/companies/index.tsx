  ...
  return (
    <Section container="full">
      ...
      <div className="no-scrollbar flex max-w-full justify-center overflow-auto">
        <div className="bg-linear-to-r pointer-events-none absolute left-0 top-0 h-full w-[30vw] bg-transparent from-surface-primary dark:from-dark-surface-primary xl:hidden" />
        <div className="bg-linear-to-l pointer-events-none absolute right-0 top-0 h-full w-[30vw] bg-transparent from-surface-primary dark:from-dark-surface-primary xl:hidden" />
        <div
